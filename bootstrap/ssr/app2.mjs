...
function run(document2) {
  document2.body.classList.remove("no-js");
  const preloadCss = document2.querySelectorAll("[rel=preload][as=style]");
...
const ZiggyVue = {
  install(app2, options) {
    ...
    if (parseInt(app2.version) > 2) {
      app2.provide("route", r);
    }
  }
};
const APP_NAME = "Danoxv";
const app = "";
...
createInertiaApp({
  ...
  resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({ "./Pages/Auth/Login.vue": () => import("./assets/Login-6a134876.mjs"), "./Pages/Site/Index.vue": () => import("./assets/Index-9ce8545e.mjs"), "./Pages/Site/Projects.vue": () => import("./assets/Projects-85aab1a8.mjs"), "./Pages/Site/Wishlist.vue": () => import("./assets/Wishlist-e61c61f6.mjs") })),
