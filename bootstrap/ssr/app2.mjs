	...
	_parse(params = {}, route2 = this._route) {
		...
		if (Array.isArray(params)) {
			params = params.reduce(
				(result, current, i) => segments[i] ? {
					...result,
					[segments[i].name]: current
				} : typeof current === "object" ? {...result, ...current} : {
					...result,
					[current]: ""
				},
				{}
...
createInertiaApp({
	...
	resolve: (name) => resolvePageComponent(`./Pages/${name}.vue`, /* @__PURE__ */ Object.assign({
		"./Pages/Auth/Login.vue": () => import("./assets/Login-8886365a.mjs"),
		"./Pages/Site/Index.vue": () => import("./assets/Index-375fcb3d.mjs")
	})),
